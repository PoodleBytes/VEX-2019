...
motor_group Drive(L_Drive, R_Drive);    //YOU DO NOT NEED THIS!!!
...
int tLift(
  ...
  while (1) {
    if (Controller1.ButtonR1.pressing() && L_Lift.rotation(deg) > -50 ) {
      ...
      Drive.spin(vex::directionType::fwd, 19, vex::velocityUnits::pct);

    } else if (Controller1.ButtonB.pressing()) {
      Drive.spin(vex::directionType::rev, 30, vex::velocityUnits::pct);
