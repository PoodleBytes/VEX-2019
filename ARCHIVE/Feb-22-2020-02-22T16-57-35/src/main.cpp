...
Drive.driveFor(forward, 600, distanceUnits::mm, 60, velocityUnits::pct);
aLift(0,10,1);
openClaw(-35, 55);
rDrive(-600,-600,50,50,1);

Drive.turnFor(left, 30, rotationUnits::deg);

drive2Target(dist2Cube);
aLift(0,8,1);
closeClaw(80);
aLift(250,30,1);
Drive.turnFor(left, 150, rotationUnits::deg);
Drive.driveFor(forward, 575, distanceUnits::mm, 60, velocityUnits::pct);
openClaw(-35, 55);
